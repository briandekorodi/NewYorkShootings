...
basic_info <- clean_data |>
  reframe("Name of the file" = gsub(".csv","", list.files("data", pattern=".csv")),
...
Notice that none of the 14 most violent NYC police precincts belong to Manhattan or Staten Island. These precincts saw a significant drop in shooting incidents overall (about 50%), that took off in 2011.
...
While all groups saw a significant decrease in shootings over the given time span, the decreases in the two most violent groups account for most of the overall city-wide change.
